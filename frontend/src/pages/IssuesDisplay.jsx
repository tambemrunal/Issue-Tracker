    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-blue-800 p-5">
        <div className="flex items-center justify-center h-64">
          ...
          <span className="text-white text-xl">Redirecting to login...</span>
        </div>
      </div>
    );
  }
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={`absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide ${getStatusStyle(
                        issue.status
                      )}`}
                    >
                      {issue.status}
